...
export default function Sidebar() {
  return (
    <StyledSidebar>
      <SidebarContainer>  
        <SidebarLinks>
          <SidebarLink to='/'><SidebarLinkIcon src={iconMeditate} /></SidebarLink>
          <SidebarLink to='/'><SidebarLinkIcon src={iconSwim} /></SidebarLink>
          <SidebarLink to='/'><SidebarLinkIcon src={iconBike} /></SidebarLink>
          <SidebarLink to='/'><SidebarLinkIcon src={iconDumbbell} /></SidebarLink>
        </SidebarLinks>
